...
console.log('case 1:')
console.log(new Basket([buy3DropPrice(sr1, 4.50)]).add(fr1).add(sr1).add(fr1).add(cf1).total())
console.log('\n')
console.log('case 2:')
console.log(new Basket([buy3DropPrice(sr1, 4.50)]).add(fr1).add(fr1).total())
console.log('\n')
console.log('case 3:')
console.log(new Basket([buy3DropPrice(sr1, 4.50)]).add(sr1).add(sr1).add(fr1).add(sr1).total())
console.log('\n')